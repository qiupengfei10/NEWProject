...
/**
 * Created by qiupengfei on 2018/1/12.
 */
public class UpdateAppManager {
    ...
    //获取新版APK的默认地址
    private String apk_path = "https://apk.kosungames.com/app-wfccp-release.apk";
    // 下载应用的进度条
     ...
     * 显示下载进度对话框
     */
    public void showDownloadDialog(String apk_url) {
        apk_path = apk_url;
