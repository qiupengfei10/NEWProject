...
/**
 * Created by qiupengfei on 2017/12/8.
 */
public class Been3 {

    /**
     * success : true
     * AppConfig : {"PushKey":null,"AcceptCount":1,"AppId":"1965246","ShowWeb":"0","Url":"http://wfcapp.cc","Remark":"接口说明：appid为唯一标示APP的字符串，调用前需要配置好。需要用到的返回值：【success】：布尔值，true 调用成功，false 请求失败，出错的情况一般就是appid传错了。【ShowWeb】：字符串，\"0\"不跳转， \"1\"跳转【PushKey】：字符串，推送用的key【Url】：字符串 跳转的url地址。"}
     */
